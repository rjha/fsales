...
namespace com\indigloo\fs\mysql {
    ...
    class Facebook {
        ...
        static function getOnFacebookId($facebookId) {
            ...
            $sql = " select * from fs_facebook_user where facebook_id = '%s' " ;
        ...
        static function create($facebookId,
             ...
             try {
                $sql1 = "insert into fs_login(name,source,access_token,created_on,expire_on,ip_address) " ;
                ...
                $sql2 = " insert into fs_facebook_user(facebook_id,name,first_name,last_name," ;
