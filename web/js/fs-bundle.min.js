...
},post:function(a,b){var d={type:"POST",dataType:"json",timeout:9000};
var c=$.extend({},d,b);
this.addSpinner(c.messageDivId);
$.ajax({url:a.endPoint,type:c.type,dataType:c.dataType,data:a.params,timeout:c.timeout,processData:true,error:function(f,e){webgloo.fs.Ajax.show(c.messageDivId,e);
},success:function(e){webgloo.fs.Ajax.show(c.messageDivId,e.message);
}});
}};
