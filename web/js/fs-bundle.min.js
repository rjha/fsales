...
e.done(function(f){webgloo.fs.Ajax.show(c.messageDivId,f.message);
if(typeof c.onDoneHandler!=="undefined"){c.onDoneHandler(f);
}});
}};
...
webgloo.fs.invoice={mail:function(c){var a={};
a.params={};
a.params.invoiceId=c;
a.endPoint="/app/action/invoice/ajax-mail.php";
var b={"dataType":"json","timeout":9000,"messageDivId":"#invoice-ajax-"+c};
webgloo.fs.Ajax.post(a,b);
},edit:function(a){alert("invoice edited");
},remind:function(a){alert("reminder sent");
},cancel:function(c){var a={};
a.params={};
a.params.invoiceId=c;
a.params.action="cancel";
a.endPoint="/app/action/invoice/ajax-command.php";
var b={"dataType":"json","timeout":9000,"messageDivId":"#invoice-ajax-"+c};
webgloo.fs.Ajax.post(a,b);
},ship:function(a){alert("invoice shipped");
},initActions:function(){$("a.invoice-action").live("click",function(a){a.preventDefault();
var c=$(this).attr("id");
var b=$(this).attr("rel");
switch(b){case"mail":webgloo.fs.invoice.mail(c);
break;
case"edit":webgloo.fs.invoice.edit(c);
break;
case"cancel":webgloo.fs.invoice.cancel(c);
break;
case"shipping":webgloo.fs.invoice.ship(c);
break;
case"reminder":webgloo.fs.invoice.remind(c);
break;
default:break;
}});
}};
